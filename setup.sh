...
echo ""
echo "Next steps:"
echo "1. Log into Kong Konnect"
echo "2. Navigate to Service Catalog"
echo "3. Add GitHub integration and connect to: $REPO_NAME"
echo "4. Follow the walkthrough in docs/WALKTHROUGH.md"
echo ""
